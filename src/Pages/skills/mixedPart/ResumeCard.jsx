...
const ResumeCard = () => {
  return (
    <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#171717] h-[190px] px-8 md:px-10 flex items-center justify-between group mt-8">
      ...
      {/* Download Button */}
      <a
        href="/src/assets/cv/nayeam_resume.pdf"
        download
