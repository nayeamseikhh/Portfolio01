...
export default function Game2048() {
  ...
  const handleMove = useCallback(
    (direction) => {
      ...
      let gained = 0;
      const next = move(grid, direction, (v) => {
        gained += v;
      });
  ...
  return (
    <div className="w-full max-w-sm mx-auto bg-black02 border my-30 border-white02/10 rounded-xl p-4 sm:p-6 font-poppins text-center">
      ...
      {status === "won" && (
        <p className="text-orange font-medium mb-3">🎉 You reached 2048!</p>
      )}
      {status === "over" && (
